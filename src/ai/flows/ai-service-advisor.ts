...
/**
 * @fileOverview This file defines the AI Service Advisor flow for Vertex Digital.
 *
...
export type AIServiceAdvisorOutput = z.infer<typeof AIServiceAdvisorOutputSchema>;

export async function aiServiceAdvisor(input: AIServiceAdvisorInput): Promise<AIServiceAdvisorOutput> {
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an AI Service Advisor for Vertex Digital, a digital services agency. Vertex Digital provides the following services:
...
Based on the client's business needs, suggest the most relevant services offered by Vertex Digital. Explain your reasoning for each suggested service.
